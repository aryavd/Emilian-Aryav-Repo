For each paper, produce a summary of the concepts, the methods presented, and how the finding might be applicable or integrated into the project. Also consider properties for the dataset and considerations for experiments that we will run later in this project. 
